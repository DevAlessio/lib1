...
local SettingsButton = {
    ...
    Text = { X = 0, Y = 16, Scale = 0.25 },
    LeftBadge = { Y = -2, Width = 40, Height = 40 },
    RightBadge = { X = 360, Y = 8, Width = 40, Height = 40 },
    RightText = { X = 415, Y = 16, Scale = 0.25 },
        ...
        if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
            ...
            if Enabled then
                ...
                if Style.RightLabel then
                    RenderText(Style.RightLabel, CurrentMenu.X + SettingsButton.RightText.X - RightBadgeOffset + CurrentMenu.WidthOffset - 25, 20 + CurrentMenu.Y + SettingsButton.RightText.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 13, SettingsButton.RightText.Scale, Active and 255 or 255, Active and 255 or 255, Active and 255 or 255, 255, 2)
                end
                ...
                -- TEXT ICI
                RenderText(not Active and Label or Label, CurrentMenu.X + SettingsButton.Text.X + LeftBadgeOffset + 28, 20 + CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 13, SettingsButton.Text.Scale, 255, 255, 255, 255);
            else
                if haveRightBadge then
                ...
                RenderText(Label, CurrentMenu.X + SettingsButton.Text.X + LeftBadgeOffset + 28, 20 + CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 13, SettingsButton.Text.Scale, 255, 255, 255, 255);
            end
