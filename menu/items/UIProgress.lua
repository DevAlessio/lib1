...
local SettingsButton = {
    ...
    SelectedSprite = { Dictionary = "RageUI_", Texture = "custom_gradient_nav", Y = 0, Width = 431, Height = 44 },
}
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                RenderSprite(SettingsButton.SelectedSprite.Dictionary, SettingsButton.SelectedSprite.Texture, CurrentMenu.X, CurrentMenu.Y + SettingsButton.SelectedSprite.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.SelectedSprite.Width + CurrentMenu.WidthOffset, SettingsButton.SelectedSprite.Height, false, CurrentMenu.Display.BackgroundItemsColor.r, CurrentMenu.Display.BackgroundItemsColor.g, CurrentMenu.Display.BackgroundItemsColor.b, CurrentMenu.Display.BackgroundItemsColor.a)

                if Selected then
                    RenderSprite(SettingsButton.SelectedSprite.Dictionary, SettingsButton.SelectedSprite.Texture, CurrentMenu.X, CurrentMenu.Y + SettingsButton.SelectedSprite.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.SelectedSprite.Width + CurrentMenu.WidthOffset, SettingsButton.SelectedSprite.Height, false, CurrentMenu.Display.BackgroundItemsColorHover.r, CurrentMenu.Display.BackgroundItemsColorHover.g, CurrentMenu.Display.BackgroundItemsColorHover.b, CurrentMenu.Display.BackgroundItemsColorHover.a)
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        RenderText(Label, CurrentMenu.X + SettingsButton.Text.X, CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.Text.Scale, 255, 0255, 255, 255)
